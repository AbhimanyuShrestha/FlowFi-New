...
var jwtSecret = builder.Configuration["Jwt:Secret"] ?? "dev-secret-min-32-chars-long-here!!";
...
builder.Services.AddCors(opt => opt.AddDefaultPolicy(p =>
    p.WithOrigins(builder.Configuration["CORS_ORIGIN"] ?? "*")
